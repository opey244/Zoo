/* global Animal, Habitat, Zoo, createZooEntities */
...
const { animals: animalEntities, habitats: habitatEntities } = createZooEntities(data);
const zoo = new Zoo(animalEntities, habitatEntities);
